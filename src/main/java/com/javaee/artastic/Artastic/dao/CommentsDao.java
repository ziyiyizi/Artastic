...
public interface CommentsDao extends JpaRepository<Comments, Long>{
	...
	@Query("select new map(ru.userName as userName, ru.comment as comment, ru.commentTime as commentTime, ru.commentorName as commentorName, u.userIcon as userIcon) from Users u, Comments ru where u.userName = ru.commentorName and ru.artworkId = :artworkId")
